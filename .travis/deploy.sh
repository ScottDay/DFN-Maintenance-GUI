...
if [[ "$REQUEST_TYPE" == "release" ]]; then
    docker push scottydevil/dfn-maintenance-gui:v$RELEASE_VERSION scottydevil/dfn-maintenance-gui:latest
...
docker push scottydevil/dfn-maintenance-gui:v$RELEASE_VERSION scottydevil/dfn-maintenance-gui:v$RELEASE_VERSION.$DEV_VERSION scottydevil/dfn-maintenance-gui:dev
